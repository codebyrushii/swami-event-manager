import { l as commonjsGlobal, m as getDefaultExportFromCjs, r as reactExports, n as clsx, R as React, o as invariant, j as jsxRuntimeExports, C as ChartColumn, P as Package } from "./index-IJURbmmR.js";
import { C as Card, c as CardHeader, d as CardTitle, a as CardContent } from "./card-D_1vsM6r.js";
import { S as Skeleton } from "./useBackend-B2_bPHxf.js";
import { T as TrendingUp } from "./trending-up-mKxKw8MO.js";
import { l as useDashboardStats, m as useRevenueByMonth, n as useBookingsByEventType, o as useTopEquipment } from "./useQueries-DVqr6F3x.js";
...
function CustomTooltip$2({ active, payload, label }) {
  if (!active || !(payload == null ? void 0 : payload.length)) return null;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-lg shadow-md px-3 py-2 text-xs", children: [
...
function BookingTrendsChart({
  ...
  const chartData = data.map((d2) => ({
    eventType: capitalize(d2.eventType),
    count: Number(d2.count)
    ...
    Card,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "pb-2 pt-4 px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardTitle, { className: "text-sm font-semibold text-foreground flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(ChartColumn, { size: 14, className: "text-accent" }),
          "Bookings by Event Type"
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "px-4 pb-4", children: [
          isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { "data-ocid": "analytics.booking_trends.loading_state", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-[200px] w-full rounded-lg" }) }) : chartData.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: "No booking data available yet."
            }
          ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full", style: { height: 220 }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: "100%", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            BarChart,
            {
              data: chartData,
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Tooltip,
                  {
                    content: /* @__PURE__ */ jsxRuntimeExports.jsx(CustomTooltip$2, {}),
          ...
          !isLoading && chartData.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2 mt-3 justify-center", children: chartData.map((entry, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
...
function CustomTooltip$1({ active, payload, label }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-lg shadow-md px-3 py-2 text-xs", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground mb-1 font-medium", children: label }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-bold text-foreground", children: new Intl.NumberFormat("en-IN", {
      style: "currency",
      currency: "INR",
...
function RevenueChart({ data, isLoading }) {
  const chartData = data.map((d2) => ({
    label: `${MONTH_NAMES[Number(d2.month) - 1]} ${String(d2.year).slice(2)}`,
    revenue: Number(d2.revenue),
    sortKey: Number(d2.year) * 100 + Number(d2.month)
  })).sort((a2, b2) => a2.sortKey - b2.sortKey).slice(-12);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "bg-card border-border", "data-ocid": "analytics.revenue.card", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "pb-2 pt-4 px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardTitle, { className: "text-sm font-semibold text-foreground flex items-center gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(TrendingUp, { size: 14, className: "text-primary" }),
      "Monthly Revenue (Last 12 Months)"
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "px-4 pb-4", children: isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        className: "space-y-2",
        "data-ocid": "analytics.revenue.loading_state",
        children: /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-[200px] w-full rounded-lg" })
      }
    ) : chartData.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        className: "flex items-center justify-center h-[200px] text-muted-foreground text-sm",
        "data-ocid": "analytics.revenue.empty_state",
        children: "No revenue data available yet."
      }
    ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full", style: { height: 220 }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: "100%", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      LineChart,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Tooltip,
            {
              content: /* @__PURE__ */ jsxRuntimeExports.jsx(CustomTooltip$1, {}),
...
function CustomTooltip({ active, payload }) {
  if (!active || !(payload == null ? void 0 : payload.length)) return null;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-lg shadow-md px-3 py-2 text-xs", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground mb-1 font-medium", children: payload[0].payload.fullName }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-bold text-foreground", children: [
      payload[0].value,
      " booking",
      payload[0].value !== 1 ? "s" : ""
...
function TopEquipmentChart({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    Card,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "pb-2 pt-4 px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardTitle, { className: "text-sm font-semibold text-foreground flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Package, { size: 14, className: "text-chart-3" }),
          "Top Equipment by Bookings"
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "px-4 pb-4", children: isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { "data-ocid": "analytics.top_equipment.loading_state", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-[200px] w-full rounded-lg" }) }) : chartData.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            className: "flex items-center justify-center h-[200px] text-muted-foreground text-sm",
            "data-ocid": "analytics.top_equipment.empty_state",
            children: "No equipment booking data yet."
          }
        ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full", style: { height: 220 }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: "100%", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          BarChart,
          {
...
function formatRupees(n2) {
  if (n2 >= 1e7) return `₹${(n2 / 1e7).toFixed(1)}Cr`;
  if (n2 >= 1e5) return `₹${(n2 / 1e5).toFixed(1)}L`;
...
function SummaryCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "bg-card border-border", "data-ocid": dataOcid, children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-3", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold tracking-widest uppercase text-muted-foreground mb-1", children: label }),
      isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-8 w-24" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-2xl font-bold font-display text-foreground truncate", children: value })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `rounded-xl p-2.5 shrink-0 ${iconBg}`, children: icon })
  ] }) }) });
}
function AnalyticsPage() {
  const { data: stats, isLoading: statsLoading } = useDashboardStats();
  const { data: revenueData = [], isLoading: revenueLoading } = useRevenueByMonth();
  const { data: eventTypeData = [], isLoading: eventTypeLoading } = useBookingsByEventType();
  const { data: topEquipment = [], isLoading: topEquipmentLoading } = useTopEquipment(5);
  const currentYear = (/* @__PURE__ */ new Date()).getFullYear();
  const ytdRevenue = revenueData.filter((d2) => Number(d2.year) === currentYear).reduce((sum, d2) => sum + Number(d2.revenue), 0);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-h2 text-foreground font-display", children: "Analytics" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm mt-0.5", children: "Revenue, bookings, and equipment insights" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { "data-ocid": "analytics.summary.section", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold tracking-widest uppercase text-muted-foreground mb-3", children: "Overview" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 sm:grid-cols-3 gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              SummaryCard,
              {
                ...
                icon: /* @__PURE__ */ jsxRuntimeExports.jsx(IndianRupee, { size: 18, className: "text-primary" }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              SummaryCard,
              {
                ...
                icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Calendar, { size: 18, className: "text-accent" }),
                iconBg: "bg-accent/15",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              SummaryCard,
              {
                ...
                icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Zap, { size: 18, className: "text-chart-3" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { "data-ocid": "analytics.revenue_chart.section", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(ChartColumn, { size: 14, className: "text-muted-foreground" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold tracking-widest uppercase text-muted-foreground", children: "Revenue Trend" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(RevenueChart, { data: revenueData, isLoading: revenueLoading })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "section",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(BookingTrendsChart, { data: eventTypeData, isLoading: eventTypeLoading }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                TopEquipmentChart,
                {
                  data: topEquipment,
